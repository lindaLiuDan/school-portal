...
public class QRCodeUtil {
    ...
    public static String qrEncode(String content, String logoImg) throws Exception {
        String imgPath = logoImg;
        String destPath = GenerateOrderNo.getOrderIdByUUId().replaceAll("-", "") + ".png";
        BufferedImage image = QRCodeUtil.createImage(content, imgPath, true);
        String Path = DictionaryTemplate.getFileParentPath() + destPath;
        mkdirs(Path);
        // String file = new Random().nextInt(99999999)+".jpg";
        // ImageIO.write(image, FORMAT_NAME, new File(destPath+"/"+file));
