...
public class IdleInfoImgServiceImpl extends ServiceImpl<IdleInfoImgDao, IdleInfoImgEntity> implements IdleInfoImgService {
     ...
     */
    @Override
    public void updateImgList(List<IdleInfoImgEntity> imgEntityList) {
//        crudRedisManager.hset(RedisKeyUtils.OwnerKeys.IDLE_IMG, idleId.toString(), JSON.toJSONString(imgEntityList), "存储闲置交易信息图片集合,Redis异常,Exception{},异常信息为:");
